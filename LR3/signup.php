<?php
require_once($_SERVER['DOCUMENT_ROOT'] . '../LR3/header.php'); // Подключение шапки
require_once($_SERVER['DOCUMENT_ROOT'] . '../LR3/.core/user_action.php'); // Подключение логики регистрации
...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '../LR3/footer.php'); // Подключение шапки ?>
