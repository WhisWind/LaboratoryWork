<?php
require_once($_SERVER['DOCUMENT_ROOT'] . '../LR4/header.php'); // Подключение шапки
require_once($_SERVER['DOCUMENT_ROOT'] . '../LR4/.core/user_action.php'); // Подключение логики регистрации
...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '../LR4/footer.php'); // Подключение шапки ?>
